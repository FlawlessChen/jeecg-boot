...
enum Api {
  ...
  queryTreeListForRoleByTenant = '/sys/role/queryTreeListForRoleByTenant',
...
export const queryTreeListForRoleByTenant = (params) => defHttp.get({ url: Api.queryTreeListForRoleByTenant,params });
